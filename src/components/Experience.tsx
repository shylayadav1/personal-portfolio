...
const experiences = [
  {
    ...
    description:
      "Developing data workflows and Power BI dashboards to track AI agent performance. Currently building a custom AI agent using Microsoft Copilot to streamline internal insights.",
  },
  {
    ...
    description:
      "Built automated data pipelines and optimized SQL queries for large-scale pharmaceutical datasets. Focused on data integrity and cloud integration.",
  },
  {
    ...
    description:
      "Assisted in training and deploying ML models. Worked on data preprocessing and feature engineering to improve model accuracy.",
  },
];
