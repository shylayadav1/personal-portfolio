      ...
      <div className="row justify-content-center">
        <div className="col-lg-8">
          ...
          >
            ...
            <h1 className ="h2 fw-bold text-light-50" style ={{fontSize: '3.7rem'}}>Shyla Yadav</h1>
          </motion.div>
              ...
              <div className="position-relative">
                ...
                <div 
                  ...
                  style={{
                    width: '320px',
                    height: '320px',
                    background: 'radial-gradient(circle, rgba(206, 184, 136, 0.15) 0%, rgba(0,0,0,0) 70%)',
                    zIndex: -1
                  }}
                />
                
                <img 
                  src="/shyla-profile.jpg" /* Replace with your actual file name */
                  alt="Shyla Yadav"
